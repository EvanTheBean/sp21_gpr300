...
void a3intro_update_scene(a3_DemoState* demoState, a3_DemoMode0_Intro* demoMode, a3f64 const dt)
{
	...
	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_cylinder,
		(a3ui32)(demoMode->obj_ground - demoMode->obj_cylinder), 3, demoState->updateAnimation);
	...
	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_capsule,
		(a3ui32)(demoMode->obj_ground - demoMode->obj_capsule), 4, demoState->updateAnimation);
	...
	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_torus,
		(a3ui32)(demoMode->obj_ground - demoMode->obj_torus), 5, demoState->updateAnimation);
	...
	a3demo_update_defaultAnimation((dt * 15.0), demoMode->obj_cone,
		(a3ui32)(demoMode->obj_ground - demoMode->obj_cone), 6, demoState->updateAnimation);
