...
void a3intro_render(a3_DemoState const* demoState, a3_DemoMode0_Intro const* demoMode, a3f64 const dt)
{
	...
	/*
	a3shaderUniformSendDouble(a3unif_single, currentDemoProgram->uAttenuation, 1, currentSceneObject->modelMatrixStackPtr.);
	a3shaderUniformSendFloat(a3unif_vec4, currentDemoProgram->uLightColor, 1, );
	*/
